...
var timeoutHandle;
var closeTime = 5000;
function createNotification(cssType, notificationType, notificationIconAria, desktopMessage, mobileMessage, containerDiv, appendChoice, closeButton = true, autoClose = false) {
    var notificationContainer = createNotificationContainer(cssType, notificationType, closeButton);
    initNotification(cssType, notificationContainer, containerDiv, appendChoice);
...
function initNotification(cssType, notificationContainer, containerDiv, appendChoice) {
    if (cssType == 'toast') {
